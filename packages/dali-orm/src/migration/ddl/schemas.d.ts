...
export declare const PermissionSchema: v.UnionSchema<[v.BooleanSchema<undefined>, v.StringSchema<undefined>], undefined>;
export declare const FieldPermissionsSchema: v.ObjectSchema<{
    readonly select: v.UnionSchema<[v.BooleanSchema<undefined>, v.StringSchema<undefined>], undefined>;
    readonly create: v.UnionSchema<[v.BooleanSchema<undefined>, v.StringSchema<undefined>], undefined>;
    readonly update: v.UnionSchema<[v.BooleanSchema<undefined>, v.StringSchema<undefined>], undefined>;
}, undefined>;
...
export declare const FieldDefinitionSchema: v.ObjectSchema<{
    ...
    readonly flex: v.OptionalSchema<v.LiteralSchema<true, undefined>, undefined>;
    ...
    readonly default_always: v.OptionalSchema<v.BooleanSchema<undefined>, undefined>;
    readonly default: v.OptionalSchema<v.StringSchema<undefined>, undefined>;
    readonly reference: v.OptionalSchema<v.ObjectSchema<{
        readonly on_delete: v.StringSchema<undefined>;
    }, undefined>, undefined>;
...
export declare const EventDefinitionSchema: v.UnionSchema<[v.ObjectSchema<{
    readonly name: v.StringSchema<undefined>;
    readonly what: v.StringSchema<undefined>;
    readonly when: v.StringSchema<undefined>;
    readonly then: v.ArraySchema<v.StringSchema<undefined>, undefined>;
    ...
    readonly then: v.ArraySchema<v.StringSchema<undefined>, undefined>;
    readonly comment: v.OptionalSchema<v.StringSchema<undefined>, undefined>;
}, undefined>, v.RecordSchema<v.StringSchema<undefined>, v.AnySchema, undefined>], undefined>;
...
export declare const IndexDefinitionSchema: v.ObjectSchema<{
    ...
    readonly comment: v.OptionalSchema<v.StringSchema<undefined>, undefined>;
    readonly prepare_remove: v.OptionalSchema<v.LiteralSchema<true, undefined>, undefined>;
...
export declare const SubscriptionDefinitionSchema: v.ObjectSchema<{
    ...
    readonly fields: v.UnionSchema<[v.LiteralSchema<"diff", undefined>, v.StringSchema<undefined>], undefined>;
    readonly what: v.StringSchema<undefined>;
...
export declare const InfoForTableSchema: v.ObjectSchema<{
    readonly events: v.OptionalSchema<v.ArraySchema<v.UnionSchema<[v.ObjectSchema<{
        readonly name: v.StringSchema<undefined>;
        readonly what: v.StringSchema<undefined>;
        readonly when: v.StringSchema<undefined>;
        readonly then: v.ArraySchema<v.StringSchema<undefined>, undefined>;
        ...
        readonly then: v.ArraySchema<v.StringSchema<undefined>, undefined>;
        readonly comment: v.OptionalSchema<v.StringSchema<undefined>, undefined>;
    }, undefined>, v.RecordSchema<v.StringSchema<undefined>, v.AnySchema, undefined>], undefined>, undefined>, readonly []>;
    ...
    readonly lives: v.OptionalSchema<v.ArraySchema<v.ObjectSchema<{
        readonly id: v.StringSchema<undefined>;
        readonly node: v.StringSchema<undefined>;
        readonly fields: v.UnionSchema<[v.LiteralSchema<"diff", undefined>, v.StringSchema<undefined>], undefined>;
        readonly what: v.StringSchema<undefined>;
    ...
    readonly tables: v.OptionalSchema<v.ArraySchema<v.StringSchema<undefined>, undefined>, readonly []>;
}, undefined>;
