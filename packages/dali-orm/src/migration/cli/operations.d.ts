 ...
 */
export declare function createConnection(config: Config, embeddedDriver?: boolean): Promise<SurrealDriver>;
/**
 ...
 */
export declare function createConnectionWithTimeout(config: Config, timeoutMs?: number): Promise<SurrealDriver>;
/**
...
export declare function printAddedSection(grouped: GroupedMap, category: string, label: string): void;
/** Print a "Removed X (N):" block with - items */
export declare function printRemovedSection(grouped: GroupedMap, category: string, label: string): void;
