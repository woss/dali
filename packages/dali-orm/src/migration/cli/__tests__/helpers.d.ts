...
export declare function createTestDriver(
  mode?: 'memory' | 'surrealkv',
  dbPath?: string,
): EmbeddedDriver;
...
export declare function createMigrationFile(
  dir: string,
  name: string,
  upStatements: string[],
): Promise<string>;
...
export declare function createSchemaFileContent(
  tables: Array<{
    name: string;
    columns: Array<{
      name: string;
