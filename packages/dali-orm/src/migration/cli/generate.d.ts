 ...
 */
export declare function getLiveSchema(
  driver: SurrealDriver,
  tableNames: string[],
 ...
 */
export declare function generateSnapshotMigration(
  tables: TableDefinition[],
...
export declare function generateLiveMigration(
  tables: TableDefinition[],
  driver: SurrealDriver,
  generator: SurrealQLGenerator,
  access?: AccessConfig[],
 ...
 */
export declare function generateFullMigration(
  tables: TableDefinition[],
  generator: SurrealQLGenerator,
  access?: AccessConfig[],
  events?: EventConfig[],
 ...
 * DROP TABLE user;
 */
export declare function generateMigrationFile(
  version: string,
  name: string,
  migration: {
    up: string[];
