 ...
 */
export declare function generateNamespaceDefinition(name: string, options?: {
    ifNotExists?: boolean;
    comment?: string;
}): string;
/**
 ...
 */
export declare function generateRemoveNamespace(name: string, ifExists?: boolean): string;
/**
 * Generate DEFINE DATABASE statement
 *
 * SurrealQL: DEFINE DATABASE [IF NOT EXISTS] <name> [COMMENT '<str>']
 */
export declare function generateDatabaseDefinition(name: string, options?: {
    ifNotExists?: boolean;
    comment?: string;
}): string;
/**
 ...
 */
export declare function generateRemoveDatabase(name: string, ifExists?: boolean): string;
/**
 ...
 */
export declare function generateRemoveEvent(eventName: string, tableName: string): string;
/**
 ...
 */
export declare function generateFunctionMigration(func: SurrealFunction): string;
/**
 ...
 */
export declare function generateSequenceDefinition(seq: SurrealSequence): string;
/**
 * Generate REMOVE SEQUENCE statement
 *
 * SurrealQL: REMOVE SEQUENCE [IF EXISTS] <name>
 */
export declare function generateRemoveSequence(seqName: string, ifExists?: boolean): string;
/**
 * Generate ALTER FIELD TYPE statement
 */
export declare function generateAlterFieldType(tableName: string, fieldName: string, newType: string): string;
/**
 * Generate ALTER TABLE PERMISSIONS statement
 */
export declare function generateAlterTablePermissions(tableName: string, permissions: TableConfig['permissions']): string;
/**
 * Generate ALTER FIELD PERMISSIONS statement
 */
export declare function generateAlterFieldPermissions(tableName: string, fieldName: string, permissions: string): string;
/**
 ...
 */
export declare function generateAlterFieldDefault(tableName: string, fieldName: string, defaultValue?: unknown, defaultRaw?: string): string;
/**
 ...
 */
export declare function generateAnalyzerDefinition(analyzer: AnalyzerDefinition): string;
/**
