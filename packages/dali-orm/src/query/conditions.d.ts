 ...
 */
export declare function allConditions(
  ...conditions: SerializedCondition[]
): SerializedCondition;
/**
 * Combine multiple conditions with OR
 */
export declare function anyConditions(
  ...conditions: SerializedCondition[]
): SerializedCondition;
/**
 * Wrap a condition with NOT
 */
export declare function negateCondition(
 ...
 */
export declare function isSerializedCondition(
  value: unknown,
