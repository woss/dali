...
export declare class CreateBuilder<TDef extends TableDefinition, TResult = InferSelectResult<TDef>> {
...
/** Factory function */
export declare function create<TDef extends TableDefinition>(orm: DaliORM, tableDef: TDef): CreateBuilder<TDef>;
