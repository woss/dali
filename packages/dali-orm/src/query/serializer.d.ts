...
export declare function andTrees(a: ConditionNode | null, b: ConditionNode): ConditionNode;
/** Convert a SerializedCondition to a special raw condition node */
export declare function serializedConditionToNode(condition: SerializedCondition): ConditionNode;
/** Serialize a condition tree to SurrealQL + params */
export declare function serializeCondition(node: ConditionNode, nextParam: (value: unknown) => string): {
    sql: string;
