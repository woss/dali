...
export declare class UpdateBuilder<TDef extends TableDefinition, TResult = InferSelectResult<TDef>> {
...
/** Factory function */
export declare function update<TDef extends TableDefinition>(orm: DaliORM, tableDef: TDef): UpdateBuilder<TDef>;
