export type SurrealColumnType = 'string' | 'int' | 'float' | 'bool' | 'datetime' | 'duration' | 'decimal' | 'array' | 'object' | 'geometry' | 'bytes' | 'record' | 'tuple' | 'any' | 'null' | 'number' | 'point' | 'uuid' | 'function' | 'set' | 'regex' | 'range' | 'table' | 'file' | 'literal';
