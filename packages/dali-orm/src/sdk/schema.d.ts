 ...
 */
export declare function generateSignupFromSQL(
  tableName: string,
 ...
 */
export declare function generateSigninFromSQL(
  tableName: string,
  table: TableDefinition,
  identifier?: string,
): string;
 ...
 */
export declare function accessToSQL(
  config: AccessConfig,
...
export declare const FunctionConfigSchema: import('valibot').ObjectSchema<
  {
    readonly name: import('valibot').StringSchema<undefined>;
    readonly args: import('valibot').OptionalSchema<
    ...
    readonly comment: import('valibot').OptionalSchema<
      import('valibot').StringSchema<undefined>,
      undefined
    >;
...
export declare const EventConfigSchema: import('valibot').ObjectSchema<
  {
    ...
    readonly then: import('valibot').ArraySchema<
      import('valibot').StringSchema<undefined>,
      undefined
    >;
    readonly comment: import('valibot').OptionalSchema<
      ...
      undefined
    >;
    readonly async: import('valibot').OptionalSchema<
      import('valibot').BooleanSchema<undefined>,
      undefined
    >;
    readonly retry: import('valibot').OptionalSchema<
      import('valibot').NumberSchema<undefined>,
      undefined
    >;
    readonly maxdepth: import('valibot').OptionalSchema<
      import('valibot').NumberSchema<undefined>,
      undefined
    >;
  },
