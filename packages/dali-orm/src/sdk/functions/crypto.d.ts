...
export declare function cryptoArgon2Compare(
  password: SqlExpr,
  hash: SqlExpr,
): SqlExpr;
...
export declare function cryptoBcryptCompare(
  password: SqlExpr,
  hash: SqlExpr,
): SqlExpr;
export declare function cryptoScryptGenerate(password: SqlExpr): SqlExpr;
export declare function cryptoScryptCompare(
  password: SqlExpr,
  hash: SqlExpr,
): SqlExpr;
export declare function cryptoPbkdf2Generate(
  password: SqlExpr,
  key: SqlExpr,
): SqlExpr;
export declare function cryptoPbkdf2Compare(
  password: SqlExpr,
  hash: SqlExpr,
): SqlExpr;
