 ...
 */
export declare const AuthConfigSchema: import("valibot").UnionSchema<[import("valibot").ObjectSchema<{
 ...
 * ```
 */
export declare function validateAuthConfig(config: unknown): AuthValidationResult;
/**
 * Convert valibot error to our format
 */
export declare function convertValibotErrors(error: unknown): AuthValidationErrorDetail[];
