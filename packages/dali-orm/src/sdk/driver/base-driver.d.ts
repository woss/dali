...
import type { DriverConfig, EmbeddedConfig, LiveData, LiveQueryOptions, LiveSubscriptionHandle, SurrealDriver, Transaction } from './types.js';
...
export declare abstract class BaseDriver implements SurrealDriver {
    ...
    protected subscriptions: Map<string, {
        created: number;
