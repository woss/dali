...
declare const AuthConfigSchema: import('valibot').UnionSchema<
  [
...
declare const DriverOptionsSchema: import('valibot').ObjectSchema<
  {
    readonly ws: import('valibot').OptionalSchema<
      import('valibot').ObjectSchema<
        {
          readonly pingInterval: import('valibot').OptionalSchema<
            import('valibot').NumberSchema<undefined>,
            undefined
          >;
          readonly pingTimeout: import('valibot').OptionalSchema<
            import('valibot').NumberSchema<undefined>,
            undefined
          >;
        },
      ...
      undefined
    >;
    readonly http: import('valibot').OptionalSchema<
      import('valibot').ObjectSchema<
        {
          readonly strict: import('valibot').OptionalSchema<
            import('valibot').BooleanSchema<undefined>,
            undefined
          >;
          readonly timeout: import('valibot').OptionalSchema<
            import('valibot').NumberSchema<undefined>,
            undefined
          >;
        },
    ...
    readonly auth: import('valibot').OptionalSchema<
      import('valibot').UnionSchema<
        [
          ...
          import('valibot').ObjectSchema<
            {
              readonly type: import('valibot').LiteralSchema<
                'namespace',
                undefined
              >;
              readonly username: import('valibot').StringSchema<undefined>;
      ...
      undefined
    >;
    readonly driver: import('valibot').OptionalSchema<
      import('valibot').ObjectSchema<
        {
          readonly ws: import('valibot').OptionalSchema<
            import('valibot').ObjectSchema<
 ...
 */
export declare function parseDriverOptions(
