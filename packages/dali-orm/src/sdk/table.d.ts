 ...
 */
export declare function defineTable<const TColumns extends Record<string, ColumnBuilder>>(name: string, columns: TColumns, config?: Omit<TableConfig, 'type'>): TableDefinition & {
    _columns: TColumns;
 ...
 */
export declare function defineRelationTable<const TColumns extends Record<string, ColumnBuilder>>(name: string, columns: TColumns, config: {
    in: string | string[];
    out: string | string[];
} & Omit<TableConfig, 'type'>): TableDefinition & {
    _columns: TColumns;
    $id(id: string | number): string;
};
