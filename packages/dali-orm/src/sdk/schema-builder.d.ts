import type { TableConfig, IndexDefinition } from './table.js';
...
export interface SchemaBuilder {
    ...
    defineIndex(name: string, index: Omit<IndexDefinition, 'name'> & {
        table: string;
    }): SchemaBuilder;
 ...
 */
export declare function createSchemaBuilder(queryFn: (sql: string) => Promise<unknown>): SchemaBuilder;
