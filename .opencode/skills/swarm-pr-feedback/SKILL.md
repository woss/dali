...
5. **Value validation vs key validation**: Bots may suggest validating env var
   _values_ for shell injection characters. Check whether the value is passed
...
_Reference: Caught during PR #1472 Round 1 closure._
...
A _separate_ reviewer + critic pair on the Stage-B-approved diff. This is the
