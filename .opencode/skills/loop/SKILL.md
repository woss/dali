...
so the next cycle is cheaper — that is what makes the loop _compounding_ rather
...
3. **State is derived, not authoritative for code.** The durable state file
   tracks _loop control_ (cycle counter, phase, gate outcomes, captured
...
```json
{
  ...
  "phase": "review",
  "success_criteria": ["...", "..."],
  "gates": [{ "cycle": 1, "phase": "plan", "result": "approved", "at": "<iso>" }],
  "improvements": [],
  "learnings": [],
  "done": false,
  "stop_reason": null,
