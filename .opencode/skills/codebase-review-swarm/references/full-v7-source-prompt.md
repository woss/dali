...
_Input validation and output encoding:_
...
_Prototype pollution and object merging:_
...
_LLM02 — Sensitive information disclosure:_
...
_LLM04 — Data and model poisoning:_
...
_LLM05 — Improper output handling:_
...
_LLM07 — System prompt leakage:_
...
_LLM08 — Vector and embedding weaknesses:_
...
_LLM10 — Unbounded consumption:_
...
_Data exfiltration via AI context:_
...
_MCP server chain lateral movement:_
...
_Build and release integrity:_
...
_Repository hygiene (OpenSSF Scorecard checks):_
...
_Test quality — behavioral vs. implementation:_
...
_Test completeness — missing negative and edge cases:_
...
_Property-based testing opportunities:_
...
_Startup and bundle (if applicable):_
...
_Simplification opportunities:_
...
_Bundle and startup (if applicable):_
